...
model = load_model(r"C:\Users\KIIT\OneDrive\Desktop\Face Detection\Face Detection\final_model.h5")

URL = 'http://100.75.127.136:8080/shot.jpg'

def get_pred_label(pred):
    labels = ['Debasish', 'Moinak', 'Priyanka', 'Sai']
    return labels[pred]
